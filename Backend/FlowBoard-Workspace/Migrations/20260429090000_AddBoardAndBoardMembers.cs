...
{
    /// <inheritdoc />
    public partial class AddBoardAndBoardMembers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Background = table.Column<string>(type: "text", nullable: false, defaultValue: "#FFFFFF"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BoardMemberId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BoardId = table.Column<int>(type: "integer", nullable: false),
